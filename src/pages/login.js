            ...
            <form className="space-y-6">
              <div className="mb-12">
                ...
                <p className="text-slate-600 text-[15px] mt-6 leading-relaxed">
                  Sign in to your account and explore the <b>WearClothes</b>.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="text-sm">
                  <Link className="text-blue-600 hover:underline font-medium" href={"/forgot"}>
              ...
              <div className="!mt-12">
                ...
                <p className="text-sm !mt-6 text-center text-slate-600">
                  Don't have an account <Link  className="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap" href={"/signup"}> Sign up here</Link>
                </p>
              </div>
            </form>
          </div>
